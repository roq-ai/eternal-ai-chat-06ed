...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Eternal AI Chat`}</title>

        <meta
          name="description"
          content="Welcome to Eternal AI Chat, your personalized platform for seamless interactions with openAI API. Log in to engage, retrieve and manage your multiple chat interactions with ease and security."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1556155092-8707de31f9c4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjaGF0JTIwYXBwbGljYXRpb258ZW58MHx8fHwxNjkyNjEzMTE0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Eternal AI Chat, your personalized platform for seamless interactions with openAI API. Log in to engage, retrieve and manage your multiple chat interactions with ease and security.`}
            </Text>
            <Box
